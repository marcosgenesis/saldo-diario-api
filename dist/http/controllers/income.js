...
export class IncomeController {
    static createIncome = asyncErrorHandler(async (request, reply) => {
        ...
        const createIncomeUseCase = new CreateIncomeUseCase(new DrizzleIncomeRepository());
        ...
        return ApiResponseBuilder.success(reply, income, "Receita criada com sucesso", 201);
    });
}
