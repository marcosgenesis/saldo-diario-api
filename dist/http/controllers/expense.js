...
export class ExpenseController {
    static createBalance = asyncErrorHandler(async (request, reply) => {
        ...
        const createExpenseUseCase = new CreateExpenseUseCase(new DrizzleExpenseRepository());
        ...
        return ApiResponseBuilder.success(reply, expense, "Despesa criada com sucesso", 201);
    });
}
