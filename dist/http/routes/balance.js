...
export async function balanceRoutes(fastify) {
    ...
    fastify.get("/api/balance/daily/period", BalanceController.getDailyBalancesByPeriod);
    // Rotas de transações
    fastify.post("/api/expenses", BalanceController.createExpense);
    fastify.post("/api/incomes", BalanceController.createIncome);
    fastify.get("/api/balances/:id/transactions", BalanceController.getBalanceWithTransactions);
}
